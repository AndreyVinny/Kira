...
const {
  removeNewLines
} = require('./helpers'); // Encode font file to data:uri and *remove* source file.
...
function encode(fontFile) {
  ...
  const fontUrl = `'data:application/x-font-${type};charset=utf-8;base64,${dataUri}'`; // Remove source file
...
function svg(fontFile) {
  ...
  const fontUrl = `'data:image/svg+xml;charset=utf8,${dataUri}'`; // Remove source file
